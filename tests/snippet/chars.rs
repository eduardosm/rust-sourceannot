...
fn test_simple() {
    ...
    let source = "123\n456";
    let snippet =
        sourceannot::Snippet::with_chars(0, source.chars(), 4, ControlCharStyle::Replacement, true);
...
fn test_tab() {
    ...
    // width 3
    let snippet =
        sourceannot::Snippet::with_chars(0, source.chars(), 3, ControlCharStyle::Replacement, true);
    ...
    // width 0
    let snippet =
        sourceannot::Snippet::with_chars(0, source.chars(), 0, ControlCharStyle::Replacement, true);
